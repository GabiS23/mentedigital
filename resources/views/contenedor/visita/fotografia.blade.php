        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="titulo-seccion">
                    ...
                    <br><br>
                    <div class="card">
                        <img src="./visita/imagen_empresa/services/sfotografia.jpg" class=" card-img-top" alt="fotografo cochabamba" style="width:310px;height:310px;">
                        <br><br>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <br>
                <img src="./visita/imagen_empresa/foto-servicios/tres.svg" class="card-img-top" alt="mentedigital Bolivia">
                <br><br>
                <img src="./visita/imagen_empresa/foto-servicios/uno.svg" class="card-img-top" alt="mentedigital Bolivia">
                <br><br>
                <!-- <img src="./visita/imagen_empresa/foto-servicios/tres.svg" class="card-img-top" alt="mentedigital Bolivia">
                <br><br> -->
                <img src="./visita/imagen_empresa/foto-servicios/cuatro.svg" class="card-img-top" alt="mentedigital Bolivia">
                <br><br>
                <!-- <div class="titulo-seccion">
                    <br><br>
